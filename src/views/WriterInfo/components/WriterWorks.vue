      ...
      <div class="author-wroks">
        ...
        >
          ...
          <div class="right">
            <div>
              <span class="big">{{
                (item.word_count / 10000).toFixed(1)
              }}</span>
...
<style scoped>
	...
	.author-wroks .notice-list-pagination .byte-pagination-item:not(.byte-pagination-item-active):not(.disabled):hover {
		background-color: rgba(255, 79, 0, .1)
	}

	.author-wroks .notice-list-pagination .byte-pagination-item-active {
		background-color: rgba(255, 79, 0, .9)
	}
