<template>
  <div class="author_talk">
    <div class="talk_title">
      <span>作家有话说 <img :src="tit1" alt="" /></span>
    </div>
    <div class="item item_one">
      <div class="con">
        ...
        <div class="text">
          <p>
            从落笔写下这个故事开始，便感觉自己随时面临挑战，想要将沉重的牺牲与少年的热血结合并不是一件容易的事情。我想写的并非只是一个人，而是一群在逆境中敢于挺身而出，秉持各自信念，向未知挑战的故事。
          </p>
          <img :src="t2" alt="" />
        </div>
      </div>
    ...
    <div class="item item_three">
      <div class="con">
        ...
        <div class="text">
          <p>
            用文字书写心中的故事，倾注全部的感情与热爱，创造一个不同于现实，但又多姿多彩的崭新的小说世界。在小说这个世界里，有你有我有他，有我们一群志同道合的人，一起奔赴。
          </p>
          <img :src="t6" alt="" />
        </div>
      </div>
...
.author_talk .con .pic img {
  height: 507px;
  width: 380px;
}

.author_talk .con .text {
  width: 660px;
}

.author_talk .con .text p {
  font-size: 18px;
  color: #000;
  line-height: 1.6;
}
...
.author_talk .item_one {
  mask: url('@/assets/images/writer/talk/talk-bkg-2.svg');
  background-color: #dad6cc;
  padding-top: 150px;
}

.author_talk .item .text img {
  width: 131px;
  vertical-align: middle;
  margin-top: 30px;
  float: right;
...
.author_talk .item_two {
  mask: url('@/assets/images/writer/talk/talk-bkg-3.svg');
  background-color: #ff5f00;
  padding-top: 100px;
}

.author_talk .item_two .con .text p {
  color: #fff;
}

.author_talk .item_three {
  mask: url('@/assets/images/writer/talk/talk-bkg-2.svg');
  background-color: #dad6cc;
  padding-top: 100px;
  margin-top: -330px;
...
.author_talk .item_three .text img {
  width: 95px;
  margin-top: 60px;
}

.author_talk .item_pic {
  margin-top: -230px;
  position: relative;
  z-index: 9;
}

.author_talk .item_pic img {
  width: 100%;
  vertical-align: middle;
}
</style>
