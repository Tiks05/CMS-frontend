	...
	<header class="header">
		<div class="header-inner">
			...
			<div class="logo" @click="goTo(`/bookinfo/${bookId}`)">	
				<svg class="muyeicon-icon muyeicon-icon-reader-icon-back" width="12" height="24" viewBox="0 0 12 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin: 2px 8px 2px 0px; vertical-align: top;">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M10.2997 18.978C10.5861 19.2658 10.5824 19.7316 10.2914 20.0148C10.0126 20.2863 9.56952 20.2904 9.28556 20.0243L1.27097 12.5125C0.907127 12.1403 0.907127 11.5368 1.27097 11.1646L9.28205 3.48947C9.56705 3.21642 10.0171 3.2182 10.2999 3.49349C10.5881 3.77396 10.5963 4.23423 10.3185 4.52485L3.32031 11.8437C3.32031 11.8437 7.32726 15.9898 10.2997 18.978Z"></path>
				</svg>
				...
				<div class="auth-dropdown" v-else @mouseenter="showDropdown" @mouseleave="hideDropdown">
					...
					<div class="dropdown-panel" v-show="dropdownVisible">
						<div class="dropdown-item" @click="goTo('/profile')">
							<img src="/src/assets/icons/update/icons8-update-windows-11-outline-32.png" class="dropdown-icon" />
							<span>修改信息</span>
						</div>
						<div class="dropdown-item" @click="handleLogout">
							<img src="/src/assets/icons/logout/icons8-logout-windows-11-filled-32.png" class="dropdown-icon" />
							<span>退出登录</span>
						</div>
					</div>
				</div>
