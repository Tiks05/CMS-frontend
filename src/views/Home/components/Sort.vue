        ...
        >
          <swiper-slide class="slide" v-for="(item, i) in sortlist" :key="i">
            <div class="item">
              ...
              <div
                class="p"
                v-for="(slide, j) in item.child"
                :key="j"
                @click="goTo(slide.path)"
                :class="item1index == j ? 'on' : ''"
                @mouseover="MouseOne(j)"
              >
                <div class="text">
                  <h4>
                    <em :class="j == 0 ? 'em0' : j == 1 ? 'em1' : j == 2 ? 'em2' : ''">{{
                      slide.num
                    }}</em
                    >{{ slide.title }}
                  </h4>
            ...
            <div class="item item_new">
              ...
              <div
                class="p"
                v-for="(slide, j) in item.new_child"
                :key="j"
                @click="goTo(slide.path)"
                :class="item2index == j ? 'on' : ''"
                @mouseover="MouseTwo(j)"
              >
                <div class="text">
                  <h4>
                    <em :class="j == 0 ? 'em0' : j == 1 ? 'em1' : j == 2 ? 'em2' : ''">{{
