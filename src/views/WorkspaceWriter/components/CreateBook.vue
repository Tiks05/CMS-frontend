    ...
    <div class="serial-card">
      ...
      <div class="noveledit">
        ...
        <div class="btn">
          ...
          <span class="btn2" @click="submitCreate">立即创建</span>
        </div>
      </div>
    </div>
...
import { createBookInfo } from '@/apis/workspace'
...
const submitCreate = async () => {
  ...
  formData.append('hero1', hero1.value.trim())
  formData.append('hero2', hero2.value.trim())
