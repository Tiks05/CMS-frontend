<template>
	<div class="home-hot-word-list">
		<div class="word-list-header">
			<div class="author-title">
				<span class="author-title-content">
					<div class="">书荒热词榜</div>
				</span>
				<span class="author-title-extra"><span class="word-list-header-title-more hoverup">查看全部
						<svg class="serial-icon serial-icon-general_arrow_circle word-list-header-title-more-icon"
							width="1em" height="1em" viewBox="0 0 32 32" fill="currentColor"
		...
		<div class="word-list-switch">
			<div class="word-list-switch-channel">
				<span :class="bill==1?'active':''" @click="bill=1">脑洞榜</span>
				<span :class="bill==2?'active':''" @click="bill=2">传统榜</span>
			</div>
			<div class="word-list-switch-type">
				<span :class="sex==1?'active':''" @click="sex=1">男频</span>
				<span :class="sex==2?'active':''" @click="sex=2">女频</span>
			</div>
		</div>
		<div class="word-list-content">
			<div class="hot-card"  v-for="(item, i) in wordlist" :key="i">
				<div class="hot-card-rank" :class="i==0?'hot-card-rank-gold1':i==1?'hot-card-rank-gold2':i==2?'hot-card-rank-gold3':''">{{item.num}}</div>
				<div class="hot-card-arrow" :class="item.type==1?'hot-card-arrow-up':'hot-card-arrow-down'">{{item.change}}</div>
				<div class="hot-card-right">
					<span class="hot-card-right-wrap">
						<span class="hot-card-right-type">
							<span class="hot-card-right-type-text">{{item.title}}</span>
							<span class="tomato-left">
...
<style scoped>
	...
	.home-hot-word-list .word-list-header {
		padding-bottom: 24px
	}
	...
	.home-hot-word-list .word-list-header-title {
		align-items: center;
		display: flex
	}
	
	.home-hot-word-list .word-list-header-title-info {
		font-size: 18px;
		font-weight: 500;
		line-height: 25px
	}
	
	.home-hot-word-list .word-list-header-title-more {
		align-items: center;
		color: #0006;
		cursor: pointer;
		display: flex;
	...
	.home-hot-word-list .word-list-header-title-more-icon {
		font-size: 14px;
		margin-left: 4px
	}
	
	.home-hot-word-list .word-list-header-time {
		color: #0000003d;
		display: block;
		font-size: 14px;
		font-weight: 400;
	...
	.home-hot-word-list .word-list-header .hot-word-list-has-new {
		display: inline-block;
		position: relative
	}
	
	.home-hot-word-list .word-list-header .hot-word-list-has-new:after {
		color: #fb4d3f;
		content: "新!";
		font-size: 12px;
		font-weight: 500;
	...
	.home-hot-word-list .word-list-content {
		margin-bottom: 12px;
		width: 100%
	}
	
	.home-hot-word-list .word-list-content .hot-card:first-of-type {
		margin-top: 21px
	}
	
	.home-hot-word-list .word-list-content .hot-card-right-type-text {
		display: inline-block;
		max-width: 350px;
		overflow: hidden;
	...
	.home-hot-word-list .word-list-content .hot-card-right-list {
		overflow: hidden;
		width: 370px
	}
	
	.home-hot-word-list .word-list-content-empty {
		color: #a4a4a4;
		font-size: 14px;
		margin-top: 120px;
		text-align: center
	...
	.home-hot-word-list .word-list-switch {
		align-items: center;
		display: flex;
		justify-content: space-between
	}
	
	.home-hot-word-list .word-list-switch-type {
		background: #f5f5f5;
		border-radius: 6px;
		height: 32px;
		margin-left: 11px;
	...
	.home-hot-word-list .word-list-switch-type span {
		border-radius: 4px;
		color: #0006;
		cursor: pointer;
		display: inline-block;
	...
	.home-hot-word-list .word-list-switch-type .active {
		background: #fff;
		color: #000;
		font-size: 14px;
		font-weight: 500
	...
	.home-hot-word-list .word-list-switch-channel span {
		color: #0006;
		cursor: pointer;
		display: inline-block;
		font-size: 16px;
	...
	.home-hot-word-list .word-list-switch-channel .active {
		color: #000;
		font-weight: 500
	}
	
	.home-hot-word-list .hot-card {
		margin-top:38px
	}
	...
	.hot-card-arrow-down,.hot-card-arrow-up {
	    padding-left: 9px
	}
	
	.hot-card-arrow-down:before {
	    border-color: #0003 #0000 #0000;
	    border-top-style: solid;
	    border-top-width: 5px;
	    top: 5px
	}
	
	.hot-card-arrow-hold:before,.hot-card-arrow-new:before {
	    display: none
	}
	...
	.hot-card-right-type .tomato-left img{width: 12px;vertical-align: 0px;}
	.hot-card-right-list {
	    color: #0006;
	    font-size: 14px;
	    font-weight: 400;
	...
	.hot-card-right-info-desc,.hot-card-right-info-title {
	    overflow: hidden;
	    text-overflow: ellipsis;
	    white-space: nowrap;
	    width: 243px
