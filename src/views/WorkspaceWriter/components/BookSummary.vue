    ...
    <div class="serial-card serial-card-normal home-book-expand">
      <div class="home-book">
        <div class="home-book-header">
          <span
            class="header-tab header-tab_right"
            :class="type == 1 ? 'active' : ''"
            @click="type = 1"
            >小说</span
          >
          ...
          <div class="header-label header-label_right" v-if="type == 1">
            <div class="hoverup">
              查看全部<span class="header-label-icon tomato-circle-right"></span>
            </div>
          </div>
          ...
          <div class="header-label header-label_left" v-if="type == 2">
            <span class="write-button">
              <div class="hoverup">
                创作短故事<span class="header-label-icon tomato-circle-add"></span>
              </div>
            </span>
          </div>
        </div>
        ...
        <div class="home-book-list" v-if="type == 1">
          <div v-if="booklist.length === 0" class="home-book-empty">
            <div class="author-empty author-empty-default">
              <img
                class="author-empty-img"
                src="@/assets/images/workspace/writer/empty.png"
                alt=""
                style="width: 129px; height: 93px"
              />
              <span class="author-empty-description"
                >记录灵感和创意，开启属于你写作世界，并持之以恒。</span
              >
                ...
                <div class="info-content">
                  ...
                  <div class="right-btns">
                    <button type="button">
                      ...
                      <div class="down_link">
                        <em @click="goTo(`/workspace/writer/book-overview/${item.id}`)"
                          >作品设置</em
                        >
                    ...
                    <button
                      type="button"
                      @click="goTo(`/workspace/writer/manage-chapter/${item.id}`)"
                    >
                      <span>章节管理</span>
                    </button>
                    <button
                      type="button"
                      class="add"
                      @click="goTo(`/workspace/writer/create-chapter/${item.id}`)"
                    >
                      <span>创建章节</span>
                    </button>
                  </div>
                ...
                <div class="book-tip-step">
                  <div class="book-tip-step-content" style="display: flex; width: auto; opacity: 1">
                    <div class="tip-step tip-step-done">
                      <div class="tip-step-line">
                        <span class="tip-step-line-dot-wrapper"
                          ><span class="tip-step-line-dot"></span
                        ></span>
                      </div>
                    ...
                    <div class="tip-step tip-step-current">
                      ...
                      <div class="tip-step-text">
                        作品可搜<span class="tip-step-tag">实名认证</span>
                      </div>
                    </div>
