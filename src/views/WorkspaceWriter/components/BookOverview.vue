                ...
                <div class="book-detail">
                  ...
                  <div class="book-detail-header">
                    ...
                    <div class="right-btns">
                      ...
                      <button
                        type="button"
                        class="add"
                        @click="goTo(`/workspace/writer/update-book/${bookDetail.id}`)"
                      >
                        <span>修改</span>
                      </button>
                    </div>
                  ...
                  <div class="book-detail-content">
                    ...
                    <div class="book-info-item">
                      ...
                      <div>
                        <span class="info-text font-1">{{ bookDetail.title }}</span>
                      </div>
                    </div>
                    ...
                    <div class="book-info-item">
                      ...
                      <div>
                        <span class="info-text font-1">{{ bookDetail.target_readers || '-' }}</span>
                      </div>
                    </div>
                    ...
                    <div class="book-info-item">
                      ...
                      <div>
                        <span class="info-text font-1">{{ bookDetail.tags || '-' }}</span>
                      </div>
                    </div>
                    ...
                    <div class="book-info-item">
                      ...
                      <div>
                        <span class="info-text font-1">{{ bookDetail.main_roles || '-' }}</span>
                      </div>
                    </div>
                    ...
                    <div class="book-info-item">
                      ...
                      <div>
                        <span class="info-text font-1">{{ bookDetail.intro }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="book-detail-content book-detail-flex" style="margin-bottom: 148px">
                    <div style="margin-right: 300px">
                      <div class="book-info-item">
                        ...
                        <div>
                          <span class="info-text font-1">{{ bookDetail.id }}</span>
                        </div>
                      </div>
                      <div class="book-info-item">
                        <span class="info-label font-2">创建时间</span>
                        <div>
                          <span class="info-text font-1">{{ bookDetail.created_at }}</span>
                        </div>
                      </div>
                      <div class="book-info-item">
                        <span class="info-label font-2">安全状态</span>
                        <div>
                          <span class="info-text font-1">{{ bookDetail.status }}</span>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="book-info-item">
                        ...
                        <div>
                          <span class="info-text font-1">{{ bookDetail.contract_status }}</span>
                        </div>
                      </div>
                      <div class="book-info-item">
                        <span class="info-label font-2">更新状态</span>
                        <div>
                          <span class="info-text font-1">{{ bookDetail.update_status }}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="book-info-sign-manage-new" v-if="type == 2">
            <div class="sign-manage-explain">
              ...
              <ul class="explain-items">
                <li>
                  作品字数达到2万字或被编辑提签后，将获得申请签约资格；详见<em>《签约问题全解》</em>
                </li>
                <li>
                  签约作品可被用户在CMS等平台查看，在一定字数后获得全平台推荐，并享有广告分成、全勤奖等各种收益，详见<em
                    >《CMS作家福利》</em
                  >
                </li>
              </ul>
...
.sign-manage-sign-ok-modal .sign-ok-bg {
  background: url(https://p9-novel.byteimg.com/origin/novel-static/12b59ebeb1e16ff24f57fac7081d6ac1)
