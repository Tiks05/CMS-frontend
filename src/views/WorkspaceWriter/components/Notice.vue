...
.home-activity .list{margin-top: 6px;}
.home-activity .list .item{line-height: 42px;cursor: pointer;
	padding-right: 25px;background-image: url('/src/assets/icons/arrow-right/icons8-arrow-100.png');background-repeat: no-repeat;background-size: 12px auto;
	background-position: right center;overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
}
.home-activity .list .item:hover{color: #ff5f00;
